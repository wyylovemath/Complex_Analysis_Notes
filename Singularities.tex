...
\section{Other types of Singularities}

\noindent\textbf{Intuition:} We've learned something  about the poles, so now we need to pay attention to some other types of isolated singularities.
